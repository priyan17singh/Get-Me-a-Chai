...
const page = () => {
  ...
  // const user = await fetchUser(session?.user?.email.split("@")[0])
  useEffect(() => {
    ...
    if (usernameFromEmail && session?.user?.desc) {
      router.push(`/${usernameFromEmail}`);
    } else {
  ...
  return (
    <div className="text-white py-14 container mx-auto">
      <h1 className="text-center font-bold text-2xl">
        Login to get support from your fans.
      </h1>
      <div className="social-media-signIn">
        <div className="flex flex-col justify-center items-center my-10">
          <button
            ...
            className="w-60 flex items-center justify-center bg-slate-800 border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-white hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 my-1"
          >
            <svg
          ...
          <button
            ...
            className="w-60 justify-center flex items-center bg-slate-800 border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-white hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 my-1"
          >
            <svg
              className="h-6 w-6 mr-2"
              xmlns="http://www.w3.org/2000/svg"
